...
$langCode = array(
	...
	'BKCafeHeaderTitle' => 'Our business, Our passion',
	...
	'meokbangBusinessProfileCon' => 'Our target customers are the youngest who love Korean culture and also fashionable customers which enjoy life such as white-collar office workers income group (18-50).<br />$25-50 per person, dining time about 2hours.<br />Korean love BBQ, so the BBQ board is extremely important. Apart from traditional Korean cuisine, MeokBang also pay attention to BBQ food items and different tyoes of seafood.<br />MeokBang aims to serve every customer with the best quality service, let customers feeling like the same when dining at BBQ restaurant in Korea.',
	...
	'FeiedRiceWithCheeseCon' => 'Served with iron plate, pour in golden beaten eggs, sprinkle large amount of cheese around the fried rice with kimchi.<br /><br />Frying the rice about one minute, cheese and egg mixed perfectly together with rice.<br /><br />The spiciness of the kimchi fried rice matches flawlessly with eggs, simple but delicious.',
